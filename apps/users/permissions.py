...
class IsTrainingManager(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (hasattr(request.user, 'role') and
                request.user.role and
                request.user.role.code in ['admin', 'hr_manager', 'training_manager'])
...
class IsExamManager(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (hasattr(request.user, 'role') and
                request.user.role and
                request.user.role.code in ['admin', 'exam_manager'])
...
class IsDeptManager(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (hasattr(request.user, 'role') and
                request.user.role and
                request.user.role.code in ['admin', 'hr_manager', 'dept_manager'])
...
class IsInstructor(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return (hasattr(request.user, 'role') and
                request.user.role and
                request.user.role.code in ['admin', 'hr_manager', 'instructor'])
